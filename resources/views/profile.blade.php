            ...
            <nav class="navbar navbar-expand-sm">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/') }}" style="color: white">Logout</a>
                        </li>
                    </ul>
                </div>
            </nav>
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    {{-- <a href=""><button type="button" class="btn btn-outline-primary ms-1">Edit Profile</button></a> --}}
                                    <a href="{{url('/register/edit')}}/{{$email}}"><button class="btn btn-outline-primary ms-1">Edit Profile</button></a>
                                </div>
                            </div>
                        </div>
